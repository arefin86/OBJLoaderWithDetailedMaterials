    ...
    for line in fileinput.input(fname):
        ...
        if len(chunks) > 0:
            ...
            if chunks[0] == "map_Kd" and len(chunks) == 2:
                ...
                materials[identifier]["mapDiffuseWrap"] = ["repeat","repeat"]
                materials[identifier]["mapDiffuseRepeat"] = [1,1]
            ...
            if chunks[0] == "map_Ka" and len(chunks) == 2:
                ...
                materials[identifier]["mapAmbientWrap"] = ["repeat","repeat"]
                materials[identifier]["mapAmbientRepeat"] = [1,1]
            ...
            if chunks[0] == "map_Ks" and len(chunks) == 2:
                ...
                materials[identifier]["mapSpecularWrap"] = ["repeat","repeat"]
                materials[identifier]["mapSpecularRepeat"] = [1,1]

            # Alpha texture
            # map_d texture_alpha.png
            if chunks[0] == "map_d" and len(chunks) == 2:
                materials[identifier]["mapAlpha"] = texture_relative_path(chunks[1])
                materials[identifier]["mapAlphaWrap"] = ["repeat","repeat"]
                materials[identifier]["mapAlphaRepeat"] = [1,1]

            # Bump texture
            # map_bump texture_bump.jpg or bump texture_bump.jpg
            if (chunks[0] == "map_bump" or chunks[0] == "bump" or chunks[0] == "map_Bump"):
                for index in xrange(len(chunks)):
                    if chunks[index] == "-bm":
                        materials[identifier]["mapNormalFactor"] = float(chunks[index+1])

                materials[identifier]["mapNormal"] = texture_relative_path(chunks[len(chunks)-1])
                materials[identifier]["mapNormalWrap"] = ["repeat","repeat"]
                materials[identifier]["mapNormalRepeat"] = [1,1]

            # environment map
            # map_refl map.png or refl map.png
            if (chunks[0] == "map_refl" or chunks[0] == "refl"):
                materials[identifier]["mapEnv"] = texture_relative_path(chunks[1])
